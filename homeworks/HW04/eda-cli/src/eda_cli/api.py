...
@app.post(
    ...
    tags=["quality"],
    summary="Полный набор флагов качества из HW03 по CSV-файлу",
)
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict:
    """
    Эндпоинт, который принимает CSV-файл и возвращает
    полный набор флагов качества данных,
    включая все эвристики, реализованные в HW03.
    """
    ...
    # здесь мы возвращаю ВСЕ флаги, а не только bool
    return {
        "flags": flags_all,
    }
